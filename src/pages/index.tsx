...
export default function Home({countries}:HomeProps) {
  ...
  // Mapping through every country's region and using Set to avoid repetitions.
	...
	return (
		...
		<div className='bg-veryLightGray min-h-screen dark:bg-veryDarkBlue border-transparent border-2'>
			<Head>
			...
			<main>
				...
				<section className='grid gap-y-12 m-12 sm:mx-8 sm:grid-cols-2 sm:gap-16 lg:grid-cols-3 lg:gap-20 lg:mx-16 dark:bg-veryDarkBlue'>
...
export const getStaticProps: GetStaticProps = async () =>{
  ...
  const countries:ICountry[] = data.map((country) => {
    ...
    const {
			alpha3Code, capital, currencies, borders, flag, languages,name, nativeName, population, region, subregion, topLevelDomain
		} = country;

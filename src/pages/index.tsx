...
export default function Home({countries}:HomeProps) {
  ...
  // Mapping through every country's region and using Set to avoid repetitions.
	...
	return (
		...
		<div className='bg-veryLightGray min-h-screen dark:bg-veryDarkBlue'>
			<Head>
			...
			<main>
				...
				<section className='grid gap-y-12 m-12 sm:mx-8 sm:grid-cols-2 sm:gap-16 lg:grid-cols-3 lg:gap-20 lg:mx-16'>
